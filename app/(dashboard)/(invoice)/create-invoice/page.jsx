          ...
          <Card className="col-span-12 xl:col-span-8 ">
            <CardHeader className="sm:flex-row sm:items-center gap-3">
              ...
              <div className="flex-none flex items-center gap-4">
                <Button>Save As PDF <Icon icon="heroicons:document-text" className="w-5 h-5 ml-2" /></Button>
                ...
                <div className="flex-1 min-w-[250px]">
                  <div className="w-full md:w-[248px] space-y-2">
                    ...
                    <div className="relative">
                      ...
                      />
                      <Icon icon="heroicons:calendar-days" className="w-5 h-5 absolute top-1/2 -translate-y-1/2 right-4 text-default-400" />
                    </div>
                    <div className="relative">
                      <Flatpickr
                        className="w-full border border-default-300 bg-background text-default-500  focus:outline-none h-10 rounded-md px-2 placeholder:text-default-500"
                ...
                <div className="flex-1 md:flex-none flex flex-col items-end w-[222px] min-w-[222px]">
                  <Label
                    ...
                    <div className="flex flex-col items-center w-full">
                      <Upload className="mr-2 h-7 w-7 mb-2 text-primary" />
              ...
              <div className="border border-default-300 rounded-md mt-9">
                      ...
                      <TableRow>
                        ...
                        <TableCell>
                          <div className="max-w-[130px] flex">
                            <Input
                              className="w-[70px] appearance-none accent-transparent rounded rounded-r-none border-r-0"
                              type="number"
                              defaultValue="1"
                            />
                            <Select className="rounded-l-none border-l-[0px] text-xs">
                              <SelectTrigger className="rounded rounded-l-none h-9  pr-1 [&>svg]:h-4 [&>svg]:w-4 [&>svg]:mt-1 ">
                ...
                <div className="flex flex-col sm:flex-row gap-4 py-5 px-6">
                  ...
                  <div className="flex-1">
                    <Button className="text-xs whitespace-nowrap"> <Plus className="w-5 h-5 mr-2" /> Add Invoice Item </Button>
                  </div>
                  {/* invoice info */}
                  <div className="flex-none flex flex-col sm:items-end gap-y-2">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-3">
                      ...
                      <div className="w-full sm:w-[148px] flex">
                        <Input
                          className=" text-xs font-medium  text-default-900 appearance-none accent-transparent rounded rounded-r-none border-r-0"
                          type="number"
                          defaultValue="34.36"
                        />
                        <Select className=" flex-none rounded-l-none border-l-[0px] text-xs" >
                          <SelectTrigger className="w-14 rounded rounded-l-none h-9 pr-1 [&>svg]:h-4 [&>svg]:w-4 [&>svg]:mt-1">
            ...
            <CardFooter className="flex-wrap justify-end gap-4">
              <Button asChild className="bg-default-200 text-xs font-semibold text-default-600 group hover:text-primary-foreground whitespace-nowrap">
                <Link href="/invoice-details"><Icon icon="heroicons:eye" className="w-5 h-5 text-default-500 mr-2 group-hover:text-primary-foreground" /> Preview</Link>
              </Button>
              <Button asChild className="group hover:bg-default-200 hover:text-default-900 text-xs font-semibold whitespace-nowrap">
                <Link href=""><Icon icon="heroicons:paper-airplane" className="w-5 h-5 mr-2 group-hover:text-default-900" /> Send Invoice</Link>
              </Button>
            </CardFooter>
          </Card>

        ...
        <div className=" py-4">
          <div className='relative'>
            <input type="text" id="floatingLabel3"
              className="block bg-background  px-3 py-2.5  w-full text-sm text-default-900 border  appearance-none focus:outline-none focus:ring-0 rounded-md  peer" placeholder="" />
        ...
        <div className="py-4">
          <div className='relative'>
            <input type="text" id="floatingLabel4"
              className="block  px-3 h-12 bg-background  rounded-md w-full text-sm text-default-900 border  appearance-none focus:outline-none focus:ring-0  peer" placeholder="" />
            <label htmlFor="floatingLabel4"
              className="absolute top-1/2 -translate-y-1/2 left-5 text-sm font-medium text-default-500  duration-300 peer-focus:-top-2 rounded
              peer-focus:bg-background peer-focus:inline-block peer-focus:px-1 peer-focus:text-xs peer-focus:left-2

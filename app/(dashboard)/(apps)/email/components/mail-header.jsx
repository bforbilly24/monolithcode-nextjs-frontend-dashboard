    ...
    <>
      <div className="flex-1 ">
        <div className="flex items-center flex-wrap gap-[3px]">
          {isDesktop && (
            <Menu
              className=" h-5 w-5 cursor-pointer text-default-600 mr-2"
              ...
              <DropdownMenuContent className="w-fit" align="end">
                <DropdownMenuItem>
                  <Icon
                    ...
                    className="w-4 h-4 text-default-600 mr-1.5"
                  />
                  Mark as important
                </DropdownMenuItem>
                <DropdownMenuItem>
                ...
                <DropdownMenuItem>
                  <ListFilter className="w-4 h-4 text-default-600 mr-1.5" />
                  Filter Message
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <MicOff className="w-4 h-4 text-default-600 mr-1.5" />
                  Mute
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <Paperclip className="w-4 h-4 text-default-600 mr-1.5" />

...
const ChatBox = ({ onClose }) => {
  ...
  return (
    <Card className="fixed z-[9999] bottom-0 right-4 w-[200px] md:[250px] lg:w-[360px]  rounded-t-md rounded-b-none dark:border dark:border-default-200 dark:border-t-0">
      <CardHeader className={cn("bg-primary  rounded-t-md flex-row items-center py-2", {
        ...
        <div className="flex-1 flex  items-center gap-3">
          <div className="relative inline-block">
            ...
            <Badge
              color="success"
              className=" h-2 w-2  p-0  items-center justify-center absolute left-[calc(100%-8px)] top-[calc(100%-8px)]"
            ></Badge>
          </div>
          <div className="text-base font-medium text-primary-foreground relative truncate w-[50px] md:w-fit">
            Jenifer Jenny
            <ChevronDown className="h-3.5 w-3.5 text-primary-foreground absolute -right-4 top-1" />
          </div>
        </div>

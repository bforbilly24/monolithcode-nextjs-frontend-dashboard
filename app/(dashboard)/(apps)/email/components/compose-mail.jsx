...
const ComposeMail = ({ onClose }) => {
  ...
  return (
    <Card
      className={cn(
        "absolute bottom-0 right-2.5 w-[300px] sm:w-[400px] md:w-[500px] lg:w-[650px] bg-background z-20",
        {
          "fixed left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 h-[calc(100vh-350px)]  lg:w-[800px] xl:w-[1000px] shadow-2xl":
            maximize,
        }
      )}
    >

...
const SingleFileCard = ({ item }) => {
  return (
    <div className="relative min-h-[164px] shadow-sm dark:border rounded">
      ...
      <div className="p-6">
        <div
          className={cn("bg-card p-2.5 h-14 w-14 rounded mx-auto", {
            hidden: item.ext === "png",
          })}
        >
          <Image
        ...
        >
          <p
            className={cn("text-base font-medium text-default-800 truncate", {
          ...
          <p
            className={cn("text-sm font-normal text-default-600", {
              "text-default-50": item?.ext == "png",
            })}
          >

...
Before you start installing MonolithCode, make sure you have a folder ready where you can open the downloaded `.zip` file.
...
#### 1. Demo: `MonolithCode-vX.X.X.zip`

This `.zip` file has the Demo version inside, which has all the apps, pages, and UI sections from the Demo app.

#### 2. Starter: `MonolithCode-starter-vX.X.X.zip`

This `.zip` file has the Starter version inside, which has all the main parts and features of MonolithCode, but without the Demo apps, pages, and UI sections. Use the Starter version to build your app on top.
